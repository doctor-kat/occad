...
} from "@/cad/solid/sketch/externalGeometry";
import { computeFingerprint } from "@/cad/solid/fingerprint";
import type { Sketch, SketchPrimitive, StableRef, Workplane } from "@/cad/types";
