...
import { inferAutoConstraints } from '@/cad/sketch/solver/autoConstraints';
import { mapElementsToPrimitives, type SketchPrimitiveDTO } from '@/cad/sketch/solver/elementsToPrimitives';
